(() => {
  ...
  var BaseConnection = class {
    constructor(config = {}) {
      ...
      __publicField(this, "disconnectionDetails", null);
      __publicField(this, "onDisconnectCallback", null);
      __publicField(this, "onMessageCallback", null);
      __publicField(this, "onModeChangeCallback", null);
  ...
  var SessionConnectionError = class extends Error {
    constructor(message, options) {
      ...
      __publicField(this, "closeReason");
  ...
  var WebRTCConnection = class _WebRTCConnection extends BaseConnection {
    constructor(room, conversationId, inputFormat, outputFormat, config = {}) {
      ...
      __publicField(this, "audioEventId", 1);
      __publicField(this, "outputDeviceId", null);
      __publicField(this, "audioAdapter");
      __publicField(this, "inputAnalyser");
      __publicField(this, "inputVolumeProvider", NO_VOLUME);
      __publicField(this, "outputAnalyser");
      __publicField(this, "outputVolumeProvider", NO_VOLUME);
...
`
  ...
  function createAnalyserVolumeProvider(analyser, sampleRate) {
    ...
    return {
      getVolume() {
        rawData ?? (rawData = new Uint8Array(binCount));
        voiceData ?? (voiceData = new Uint8Array(binCount));
  ...
  var MediaDeviceOutput = class _MediaDeviceOutput {
    constructor(context, analyser, gain, worklet, audioElement) {
      ...
      __publicField(this, "interruptTimeout", null);
      __publicField(this, "volumeProvider");
      this.context = context;
...
`
  ...
  var MediaDeviceInput = class _MediaDeviceInput {
    constructor(context, analyser, worklet, inputStream, mediaStreamSource, permissions, onError = console.error) {
      ...
      __publicField(this, "analyser");
      __publicField(this, "worklet");
      __publicField(this, "inputStream");
      __publicField(this, "mediaStreamSource");
      __publicField(this, "permissions");
      __publicField(this, "onError");
      __publicField(this, "muted", false);
      __publicField(this, "volumeProvider");
      __publicField(this, "settingInput", false);
      __publicField(this, "handlePermissionsChange", () => {
  ...
  var WebSocketConnection = class _WebSocketConnection extends BaseConnection {
    constructor(socket, conversationId, inputFormat, outputFormat) {
      ...
      __publicField(this, "inputFormat");
      __publicField(this, "outputFormat");
      __publicField(this, "outputListeners", /* @__PURE__ */ new Set());
      __publicField(this, "pendingAudioEvents", []);
      this.socket = socket;
      this.conversationId = conversationId;
      this.inputFormat = inputFormat;
      this.outputFormat = outputFormat;
  ...
  var WebAudioAdapter = class {
    constructor() {
      __publicField(this, "audioElements", []);
      __publicField(this, "inputAudioContext", null);
      __publicField(this, "audioCaptureContext", null);
    }
...
`
  ...
  var BaseConversation = class {
    constructor(options, connection) {
      ...
      __publicField(this, "lastInterruptTimestamp", 0);
      __publicField(this, "mode", "listening");
      __publicField(this, "status", "connecting");
      __publicField(this, "volume", 1);
      __publicField(this, "currentEventId", 1);
      __publicField(this, "canSendFeedback", false);
      __publicField(this, "endSessionWithDetails", async (details) => {
      ...
      __publicField(this, "onMessage", async (parsedEvent) => {
  ...
  var _VoiceConversation = class _VoiceConversation extends BaseConversation {
    constructor(options, connection, input, output, playbackEventTarget, cleanUp) {
      super(options, connection);
      __publicField(this, "input");
      __publicField(this, "output");
      __publicField(this, "playbackEventTarget");
      __publicField(this, "cleanUp");
      __publicField(this, "type", "voice");
      __publicField(this, "inputFrequencyData");
      __publicField(this, "outputFrequencyData");
      __publicField(this, "handlePlaybackEvent", (event) => {
    ...
    getInputByteFrequencyData() {
      this.inputFrequencyData ?? (this.inputFrequencyData = new Uint8Array(_VoiceConversation.FREQUENCY_BIN_COUNT));
      this.input.getByteFrequencyData(this.inputFrequencyData);
      return this.inputFrequencyData;
    }
    getOutputByteFrequencyData() {
      this.outputFrequencyData ?? (this.outputFrequencyData = new Uint8Array(_VoiceConversation.FREQUENCY_BIN_COUNT));
  ...
  __publicField(_VoiceConversation, "FREQUENCY_BIN_COUNT", 1024);
  var VoiceConversation = _VoiceConversation;
  ...
  async function start(options) {
    ...
    try {
      ...
      if (!tokenRes.ok) {
        let msg = "No se pudo obtener el token de conversaci\xF3n";
        try {
      ...
      if (!conversationToken) {
        throw new Error("Token vac\xEDo");
      }
      ...
      const conversation = await Conversation.startSession({
        ...
        clientTools: {
          show_action_buttons: (parameters) => {
            const actions = Array.isArray(parameters?.actions) ? parameters.actions.filter((a) => typeof a === "string") : [];
